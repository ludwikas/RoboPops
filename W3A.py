...
interval = 0.006                                        ###### NOT more than 0.05
...
tcp_data, marker_tcp_data = W3A_A_Send_Collect_Main_and_Intervals.monitor_tcp_pose_and_speed_combined(robot_ip, notification_port=notification_port, interval = interval, total_moves=total_moves)

...
ip_address = "145.94.225.59"                           ###### Use "ipconfig" in your terminal to colelect your personal IPV4 (changes every time you close your pc)
message_prefix = "Move"                                 ## Important for formatting 
file_path_1f = "Formatted_URscript.txt"                 ## File name
robot_ip = "192.168.60.128"                             ## Robot ip

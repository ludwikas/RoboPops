...
import W7_Calculate_StepDelay_Interpolate_Format
...
V_p = W7_Calculate_StepDelay_Interpolate_Format.calculate_Vp(ρ, m)            # mm^3 per 1 revolution       ### Calculated through testing
...
v_new = W7_Calculate_StepDelay_Interpolate_Format.read_v_values(output_file_path_l2speed)
step_delay_values = W7_Calculate_StepDelay_Interpolate_Format.calculate_step_delay(Ns, V_p, w_target, h_target, v_new)
old_max = W7_Calculate_StepDelay_Interpolate_Format.sort_max_delay(step_delay_values)
old_min = W7_Calculate_StepDelay_Interpolate_Format.sort_min_delay(step_delay_values)
voltage_values = W7_Calculate_StepDelay_Interpolate_Format.map_step_delay_to_voltage(step_delay_values, old_min, old_max, new_min, new_max)
W7_Calculate_StepDelay_Interpolate_Format.format_urscript_voltages(file_path_urscript_newl, output_file_path_FinalFormat, voltage_values)

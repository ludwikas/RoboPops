...
robot_ip = "192.168.60.128"                                 ##### Update with your robot ip for simulator
#File paths
...
W3B_L_Detect_Speed_Pattern_and_Find_TCPs.save_combined_tcp_to_file(combined_tcp_poses, speed_data, main_with_indices)

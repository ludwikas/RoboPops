        ...
        while monitoring:
            ...
            try:
                ...
                if "Move end" in data:
                    ...
                    # Start monitoring at "Move end 2"
...
# Helper function to compare two poses for approximate equality
...
def main():
    ...
    # Step 5: Write the collected TCP poses and speeds to separate .txt files
